...
class _QuarkWindowCheckState extends State<QuarkWindowCheck>
  ...
  void scroll(double dy) {
    if (rotatedAngle < 0) {
      rotatedAngle += dy / 180;
      rotatedAngle = min(0, rotatedAngle);
      rotatedAngle = max(-2 * pi, rotatedAngle);
      return;
    }
    // Log.d(dy);
    if (offsetList[1] > 160) {
        ...
        body: GestureDetector(
          ...
          onVerticalDragEnd: (DragEndDetails details) {
            ...
            final ClampingScrollSimulation clampingScrollSimulation =
              ...
              position: start,
              velocity: -details.velocity.pixelsPerSecond.dy * 2 / 3,
              tolerance: tolerance,
            );
            animationController = AnimationController(
              vsync: this,
